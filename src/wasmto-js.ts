...
import {Base64TransformStream, IntoGeneratorCodeTransformStream, AppendTrailerTransformStream} from "./stream";
import {compile} from "../gen/fragments";
import {decode} from "@webassemblyjs/wasm-parser";
import * as ast from "@webassemblyjs/ast";

export async function wasmtoJs(input: ReadableStream<Uint8Array>, output: WritableStream<Uint8Array>) {
    // TODO check header
    await input
